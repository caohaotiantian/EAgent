...
import { Agent, currentActingAgent, currentRootAgent } from "../kernel/agent.ts";
import type { RunResult } from "../kernel/agent.ts";
import { defineTool, fail, ok } from "../kernel/define.ts";
import type { ExtensionAPI } from "../kernel/extension.ts";
import { ToolRegistry } from "../kernel/registry.ts";
import type { Tool } from "../kernel/types.ts";
import { finalText, resolveChildCapabilities, resolveChildProvider } from "./subagents.ts";
import { SPAWN_CAPS } from "./teams.ts";
