...
import type { CapabilityManager } from "../kernel/capabilities.ts";
import { defineTool, fail, ok } from "../kernel/define.ts";
import type { KernelEvents, KernelFilters, ToolDecision } from "../kernel/events.ts";
import type { ExtensionAPI } from "../kernel/extension.ts";
import type { Config } from "../kernel/store.ts";
import type { HookBus } from "../kernel/hooks.ts";
import { ProviderRegistry, ToolRegistry } from "../kernel/registry.ts";
import type { Logger, Message, ThinkingLevel, Tool, UI } from "../kernel/types.ts";

import { childRegistryFrom } from "./lib/child-registry.ts";
import { loadLayered, resourceDirs } from "./lib/resource-dirs.ts";
import { scopedCapabilities } from "./subagents.ts";
