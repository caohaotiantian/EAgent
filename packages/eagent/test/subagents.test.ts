...
import subagents, { childRegistryFrom, readOnlyCapabilities } from "../src/extensions/subagents.ts";
import { CapabilityError } from "../src/kernel/capabilities.ts";
import { defineTool } from "../src/kernel/define.ts";
import type { Agent } from "../src/kernel/agent.ts";
import { lastText, makeHarness, RenamedProvider } from "./helpers.ts";
