...
import { normalizeForInspection } from "../src/extensions/lib/decode.ts";
import bashPolicy, { type Rule } from "../src/extensions/bash-policy.ts";
import riskGuard from "../src/extensions/risk-guard.ts";
