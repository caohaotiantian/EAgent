...
import compact, { tokenEstimate, splitIndex, PIN_MAX_BYTES } from "../src/extensions/compact.ts";
import memory from "../src/extensions/memory.ts";
import type { ExtensionAPI } from "../src/kernel/extension.ts";
import type { CompletionRequest, Message, ToolContext } from "../src/kernel/types.ts";
