...
import { defineTool, ok, fail } from "../src/kernel/define.ts";
import { Hanging, makeHarness, type Harness } from "./helpers.ts";
import evals, {
  checkExpect,
  parseJudgeReply,
  parseEvalScenario,
...
function toolCtx(h: Harness): import("../src/kernel/types.ts").ToolContext {
  return {
    toolCallId: "t1",
