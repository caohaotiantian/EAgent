...
import teams, {
  ...
  type ResolvedTeam,
  type Team,
} from "../src/extensions/teams.ts";
import templates, { type ResolvedTemplate, type Template } from "../src/extensions/templates.ts";
import type { CommandContext } from "../src/kernel/commands.ts";
import { defineTool } from "../src/kernel/define.ts";
import type { CompletionRequest, Message, Tool, ToolContext } from "../src/kernel/types.ts";
