...
import driftProbe, {
  ...
  isRegression,
  type Probe,
} from "../src/extensions/drift-probe.ts";
import type { ExtensionAPI } from "../src/kernel/extension.ts";
import type { CompletionRequest, Logger, Message, UI } from "../src/kernel/types.ts";
import { MockProvider } from "../src/providers/mock.ts";
import { makeHarness, siblingAgent, silentLogger, type Harness } from "./helpers.ts";
