...
echo "    loom exam attest exams/review-bench-exam.json --cohort <a review-bench run> --as <you>"
echo "    loom promote candidates/review-bench-v2.json --against-cohort <that run> --models-file models.json"
